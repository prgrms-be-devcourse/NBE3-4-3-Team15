...
--insert into review(`created_at`, `modified_at`, `book_id`, `content`, `is_delete`, `rating`, `member_id`)
--    VALUES (now(), now(), '1', "리뷰입니다.", false, '10', '1')
--    ON DUPLICATE KEY UPDATE modified_at = now();
--
--insert into review_comment(`created_at`, `modified_at`, `comment`, `depth`, `is_delete`, `member_id`, `parent_id`, `review_id`)
--    VALUES (now(), now(), '댓글입니다.', '0', false, '2', '0', '1')
--    ON DUPLICATE KEY UPDATE modified_at = now();
--
--insert into challenge(`created_at`, `modified_at`, `content`, `end_date`, `name`, `start_date`, `status`, `total_deposit`)
--    VALUES (now(), now(), '한달간 출석을 잘 합니다.', '2025-03-07 02:04:17.105', '한달 챌린지1', '2025-04-07 02:04:17.105', 'START', '0'),
--     (now(), now(), '한달간 출석을 잘 합니다.', '2025-03-07 02:04:17.105', '한달 챌린지2', '2025-04-07 02:04:17.105', 'START', '0')
--     ON DUPLICATE KEY UPDATE modified_at = now();
--
